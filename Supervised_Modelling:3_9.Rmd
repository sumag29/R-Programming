---
title: "Cont.. of Supervised Modelling"
author: "Suma Gandham"
...
# this value is standardised n we created logs so avg 0 and sd 1 so if we consider 2546.29 avg and add the sd 804.3508 they we increase by 21.39%, the avg and sd r meant to be constant
...
ames_clean|>
summarise(avg_total_bath=mean(total_bath,na.rm=T),sd_total_bath=sd(total_bath))
#for interpretation purpose
#avg--> 2.44 -> 2.5 
#sd --> 0.941 - > 1 more bath
